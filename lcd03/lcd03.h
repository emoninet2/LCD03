...
// #define i2c_send(data)
// #define serial_send(data)
...
//functions
public:
	lcd03(COMM_MODE_t,LCD_SIZE_t,LCD03_I2C_ADDRESS_t);
	/**
	 * i2c transcieve
	 */
	void send_via_i2c(uint8_t data);
	/**
	 * serial transcieve
	 */
	void send_via_serial(uint8_t data);
	/**
	 * send command
	 */
